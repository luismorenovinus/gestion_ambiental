<div class="row-fluid">
		...
		<div class="span6">
			<div class="row-fluid">
			    ...
			    <div class="box-content">
					<button class="btn btn-large btn-block btn-danger btn-primary" type="button" onClick="window.location = 'reporte/plantilla_solicitud'">Generar</button>
		    	</div>
			</div>
	    </div>
	<?php } ?>
	...
	<?php if (isset($acceso[29])) { ?>
		<div class="span6">
			<div class="row-fluid">
			 	<div class="box-header"><h2>Reporte consolidado total de solicitudes por tramo</h2></div>
			    <div class="box-content">
					<button class="btn btn-large btn-block btn-success btn-primary" type="button" onClick="window.location = 'reporte/consolidado_tramos'">Generar</button>
			    </div>
			</div>
		</div>
	<?php } ?>
		...
		<div class="span6">
			<div class="row-fluid">
			    ...
			    <div class="box-content">
					...
					<button id="btn_ica0" class="btn btn-large btn-block btn-success btn-primary" type="button" disabled>Informe ICA 0</button>
			    </div>
			</div>
		</div>
	<?php } ?>
	...
	<div class="span6">
		<div class="box-header"><h2>Informes mensuales</h2></div>
	    <div class="box-content">
	    	<div class="row-fluid">
	    		<!--Validar permiso-->
	...
	<?php if (isset($acceso[31])) { ?>
		<div class="span6">
    		...
    		<!-- <button class="btn btn-large btn-block btn-danger btn-primary" type="button" onClick="window.location = 'reporte/registro_fotografico_1a'" disabled>ICA 1a Solla Niquía 2013</button> -->
		</div>
    	<?php } ?>
</div>
